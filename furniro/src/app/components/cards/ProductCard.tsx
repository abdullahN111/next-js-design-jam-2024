  ...
  ? Array.from({ length: 4 }).map((_, index) => (
      ...
      >
        ...
        : products.slice(0, showProducts).map((card) => (
            <div
              key={card._id}
              className="relative flex flex-col w-[240px] sm:w-auto h-[350px] lg:h-[335px] bg-[#F4F5F7] rounded-sm shadow-md overflow-hidden sm:mx-10 md:mx-2 lg:mx-0 transition-transform duration-300"
            >
